...
Функция ПолучитьНаборСлучайныхПользователей(ПараметрыЗаполнения) Экспорт
	...
	НаборСлучайныхПользователей	= Новый Массив;
	...
	Для СчетчикЭлементов = 1 По ПараметрыЗаполнения.КоличествоСлучайныхИмен Цикл
		...
		НаборСлучайныхПользователей.Добавить(СокрЛП(ПредставлениеФИО));
	КонецЦикла;
